...
struct Args {
    ...
    #[arg(long)]
    defconfig: String,
    /// For GitHub Actions: Pathname of downloaded Run Log
    #[arg(long, default_value = "")]
    file: String,
    /// For GitHub Actions: Run ID (`11603561928`)
    #[arg(long, default_value = "")]
    run_id: String,
    /// For GitHub Actions: Job ID (`32310817851`)
    #[arg(long, default_value = "")]
    job_id: String,
    /// For GitHub Actions: Step inside the Job (`7`)
    #[arg(long, default_value = "")]
    step: String,
}
